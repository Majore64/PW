<template>
  <div class="popup">
    <div class="popup-inner">
      <h2 class="popup-title">Novo Material</h2>

      <form @submit.prevent="handleSubmit">
        <div class="form-container">
          <div class="form-section">
            <h3>Nome material</h3>
            <input v-model="form.nomeMaterial" type="text" class="form-input" placeholder="Insira o nome do material ..." />

            <h3>Quantidade</h3>
            <input v-model="form.quantidade" type="number" class="form-input" placeholder="Insira a quantidade do material ..." />
          </div>
        </div>
...
methods: {
  handleSubmit() {
    const quantidade = parseInt(this.form.quantidade);

    if (!this.form.nomeMaterial || isNaN(quantidade)) {
      alert('Preenche o nome e a quantidade corretamente.');
    return;
    }
    ...
    this.$emit('material-adicionado', novoMaterial);
    this.togglePopup();
